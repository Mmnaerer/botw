...
banChats = false
offline = false
ownerNumber = '6285955372133'
targetpc = '6285955372133'
owner = '6285955372133'
fake = 'Beta Bot By IWasHuman'
numbernye = '0'
waktu = '-'
alasan = '-'
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:IWasHuman\n'
            + 'ORG:YNTKTS;\n'
            + 'TEL;type=CELL;type=VOICE;waid=6285955372133:+62 859-5537-2133\n'
            + 'END:VCARD'
//=================================================//
...
module.exports = hexa = async (hexa, mek) => {
	try {
		...
		const ownerNumber = ['6285955372133@s.whatsapp.net']
        ...
        //MESS
		mess = {
            	owneronly: 'Hanya Owner Yang Bisa Memakai Fitur Ini !',
...
const textImg = (teks) => {
   ...
   //FAKEREPLY PRODUCT
            ...
            //FAKEREPLY TROLI
            const ftroli = {
                  key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6285955372133@s.whatsapp.net" } : {})},message: {orderMessage: {itemCount : 2021,status: 1,surface : 1,message: `${ucapanWaktu} Kak\n ${pushname}\n 😘`,orderTitle: 'Bang',thumbnail: fs.readFileSync('./stik/thumb.jpeg'), sellerJid: '0@s.whatsapp.net'}}}
const fakevn = {
	 key: { 
          fromMe: false,
	 ...
	 message: { 
		"audioMessage": {
            ...
            //FAKEREPLY VIDEO
            const fvideo = {
                  key: {fromMe: false,participant: `6285955372133@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title":"hallo bang","h": `Hmm`,'seconds': '-99999', 'caption': `${fake}`,'jpegThumbnail': fs.readFileSync('./stik/thumb.jpeg')}}}
const fvid = {
	 key: { 
	 ...
	 message: { 
            ...
            const fgc = {
                  key: {"fromMe": false,"participant": "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6285955372133-1616169743@g.us","inviteCode": "mememteeeekkeke","groupName": "P", "caption": `${fake}`, 'jpegThumbnail': fs.readFileSync('./stik/thumb.jpeg')}}}
            //FAKEREPLY GIF
            const fgif = {
                  key: {fromMe: false,participant: `6285955372133@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title":"hallo bang","h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `${fake}`,'jpegThumbnail': fs.readFileSync('./stik/thumb.jpeg')}}} 
...
//========================================================================================================================//
        ...
        let id_vote = sender ? sender : '6285955372133@s.whatsapp.net'
...
switch (command) {
    ...
    break
    case 'stopjadibot':
    if(!mek.key.fromMe)return reply('tidak bisa stop jadibot kecuali owner')
    stopjadibot(reply)
    break
case 'leaveall':
             if (!isOwner) return  
             ...
             sendMess(id, 'Selamat Tinggal semua ^^\nOwnerku menyuruhku untuk keluar dari semua group !', null)
             await sleep(3000)
             hexa.groupLeave(id)
}
             break
...
*Model* : ${i.phone.device_model}\n\n`
    ...
    case 'help':
        ...
        txtt =`Hai kak ${pushname}\nSilahkan Pilih daftar di bawah ini :)`

               buttons = [{buttonId:`${prefix}menu1`,buttonText:{displayText: 'List Menu 📋'},type:1},
               {buttonId:`${prefix}owner`,buttonText:{displayText:'Developer Bot 🤖'},type:1},
               {buttonId:`${prefix}ytadmin`,buttonText:{displayText:'YouTube 🎥'},type:1}]

               imageMsg = (await hexa.prepareMessageMedia(fs.readFileSync(`./stik/banner_menu.png`), 'imageMessage', {thumbnail: fs.readFileSync(`./stik/banner_menu.png`)})).imageMessage

               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: '© Creator By IWasHuman\nSubcribe Channel saya\nTekan tombol dibawah', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}

               prep = await hexa.prepareMessageFromContent(from,{buttonsMessage},{quoted: fakevn})//fakevn
               hexa.relayWAMessage(prep)
               break
               
case 'menu1':
    case 'help1':
    wew = fs.readFileSync(`./stik/banner_menu.png`)
    	var menu = `*╭─❒ 「 Public Bot 」 ──────*
*│*
*│*⬡ *Hai ${ucapanWaktu}*
*│*⬡ *Nama : ${pushname}*
...
*│*
*└─────────────*`
buttons = [{buttonId: `${prefix}mowner`,buttonText:{displayText: 'Menu Owner ❌'},type:1},{buttonId: `${prefix}mgroup`,buttonText:{displayText: 'Menu Group 🤖'},type:1},{buttonId: `${prefix}update`,buttonText:{displayText: 'Update Logs 📖'},type:1}]

               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '© Created By IWasHuman',
               buttons: buttons,
               headerType: 1
}
...
//------------------< Fitur Anti antian >-------------------
 ...
 case 'owner':
            case 'developer':
            case 'author':
                hexa.sendMessage(from, {displayname: "IWasHuman", vcard: vcard}, MessageType.contact, { quoted: ftroli})
                    .then((res) => hexa.sendMessage(from, 'Jangan Lupa Di Save', text, {quoted: res}))
                    
                break
   case 'shutdown':
           if (!mek.key.fromMe) return 
             reply(`Selamat tinggal bang, Bot offline`)
             await sleep(3000)
             process.exit()
             break
...
case 'add':
 ...
 case 'ytadmin' :
           reply('subslah bang')
           await reply('https://youtube.com/c/IWasHuman') 
               break
case 'buttons1':
